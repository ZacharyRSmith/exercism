class FoodChain
  ...
  private_class_method :_first_verse_lines
  ...
  private_class_method :_repeated_lines
  ...
  private_class_method :_verse

  def self._first_verse_line(animal)
    "I know an old lady who swallowed a #{animal}.\n"
  end
  private_class_method :_first_verse_line
end
