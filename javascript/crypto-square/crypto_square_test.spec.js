...
describe('Crypto',function() {
  ...
  xit('size of small square wxith addxitional non-nuber chars',function() {
  ...
  xit('plain text segments',function() {
    var crypto = new Crypto('Never vex thine heart wxith idle woes');
    expect(crypto.plaintextSegments()).toEqual(['neverv', 'exthin', 'eheart', 'wxithid', 'lewoes']);
  });
